...
# scores = cross_val_score(rnd_forest, housing_prepared, housing_labels, scoring="neg_mean_squared_error", cv=10)
...
grid_search = GridSearchCV(rnd_forest, param_grid, cv=5, scoring='neg_mean_squared_error')
